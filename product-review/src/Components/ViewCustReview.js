...
class ViewCustReview extends React.Component{
    ...
    constructor(props){
     ...
     submitProduct(e) {
        ...
        fetch('http://localhost:8086/Application/Admin/review/view/'+this.state.productName)
        .then(res => res.json())
        .then(json => {
            this.setState({
                reviews: json
